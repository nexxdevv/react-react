...
const Footer = () => {
	...
	return (
		<StyledFooter className="px-5 pt-12 pb-10">
			<div className="grid grid-cols-2 gap-y-6 gap-x-7">
				<div className=" flex flex-col capitalize">
					<h3 className="text-gray-400 font-bold mb-4 uppercase">Docs</h3>
					{docs.map((link) => (
				...
				<div className=" flex flex-col capitalize">
					<h3 className="text-gray-400 font-bold mb-4 uppercase">channels</h3>
					{channels.map((link) => (
						<Link to="/" key={link} className="mb-2 flex items-center space-x-2 whitespace-nowrap">
							<p>{link}</p>
				...
				<div id="comm" className=" flex flex-col capitalize">
					<h3 className="text-gray-400 font-bold mb-4 uppercase">community</h3>
					{comm.map((link) => (
				...
				<div id="more" className=" flex flex-col capitalize">
					<h3 className="text-gray-400 font-bold mb-4 uppercase">more</h3>
					{more.map((link) => (
						<Link to="/" key={link} className="mb-2">
							{link}
						</Link>
